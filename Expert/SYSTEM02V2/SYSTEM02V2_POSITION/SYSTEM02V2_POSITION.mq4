         ...
         if(signal == "Buy" && NoOpenOrdersForSymbol() == true)
           {
            if(POSITION == L || POSITION == A)
              {
               int ticket = OrderSend(Symbol(),OP_BUY,lotBuy,Ask,5,psar - spreadSL,open + tpBuy,NULL,0,0,clrGreen);
              }
           }
         ...
         if(signal == "Sell" && NoOpenOrdersForSymbol() == true)
           {
            if(POSITION == S || POSITION == A)
              {
               int ticket = OrderSend(Symbol(),OP_SELL,lotSell,Bid,5,psar + spreadSL,open - tpSell,NULL,0,0,clrRed);
              }
           }
