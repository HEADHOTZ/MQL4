            ...
            if(OrderType() == OP_BUY)
              {
               ...
               double diffBuy = OrderOpenPrice() - stoploss;
               double lineTP = ((followingPoint + FOLLOWING) * diffBuy) + OrderOpenPrice();
               double followTP = (followingPoint * diffBuy) + OrderOpenPrice();
               double tralingLine = ((followingPoint - FOLLOWING) * diffBuy) + OrderOpenPrice();
            ...
            if(OrderType() == OP_SELL)
              {
               ...
               Print("Line TP : ",lineTP);
               Print("follow TP : ",followTP);
               Print("Traling Line : ",tralingLine);
               Print("Diff : ",diff);
